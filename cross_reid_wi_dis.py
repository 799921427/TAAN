...
from reid.trainers_two_wi_D import Trainer
...
def main(args):
    ...
    model_t, model_discriminator = models.create(args.arch, num_classes=num_classes, num_features=args.features, attention_mode=args.att_mode)
    model_s = models.create('baseline_wo_D', num_classes=295, num_features=args.features, attention_mode=args.att_mode)
    # load source network
    checkpoint_s = load_checkpoint('/home/fan/cross_reid/2000_mode1/model_best.pth.tar')
    ...
    trainer = Trainer(model_s, model_t, model_discriminator, criterion_z, criterion_I, criterion_att, criterion_D, trainvallabel, 1, 1 , 0.15, 0.05, 5)
    ...
    for epoch in range(start_epoch, args.epochs):
        scheduler.step()
        triple_loss, tot_loss, att_loss, D_loss = trainer.train(epoch, train_loader, optimizer_ft, optimizer_discriminator)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mile_stone', type=list, default=[1200,1600])
