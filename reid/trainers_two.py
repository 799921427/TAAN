...
class BaseTrainer(object):
    def __init__(self, model_s, model_t, criterion_z, criterion_I, criterion_att, trainvallabel, a, b, c, u, k):
    ...
    def train(self, epoch, data_loader, optimizer_generator_I, print_freq=1):
        ...
        for i, inputs in enumerate(data_loader):
            ...
            # Calc the loss
            loss_t, loss_id, loss_attention = self._forward(inputs, label, sub)
            L = self.a * loss_t + self.b * loss_id + self.c * loss_attention
        ...
        return losses_triple.avg, losses_generator.avg, losses_attention.avg
...
class Trainer(BaseTrainer):
    ...
    def _forward(self, inputs, label, sub):
        ...
        outputs_t, outputs_pool, feature_map_t = self.model_s(inputs)
        ...
        return  loss_t, loss_id, loss_att
